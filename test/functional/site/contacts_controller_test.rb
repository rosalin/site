...
class Site::ContactsControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create site_contact" do
    assert_difference('Site::Contact.count') do
      post :create, site_contact: {  }
    end
  ...
  test "should update site_contact" do
    put :update, id: @site_contact, site_contact: {  }
    assert_redirected_to site_contact_path(assigns(:site_contact))
  end

  test "should destroy site_contact" do
    assert_difference('Site::Contact.count', -1) do
